$(function(){	
	...
	$("#allSearchBtn").on("click", function(){
		locationProcess("/noticeBoard/noticeBoardList");
	});
	...
	$(".page-item a").on("click", function(e){
		...
		actionProcess("#searchForm", "get", "/noticeBoard/noticeBoardList");
		$("#pageNum").find("input[name='pageNum']").val($(this).attr("href"));
		actionProcess("#pageNum", "get", "/noticeBoard/noticeBoardList");
	});
