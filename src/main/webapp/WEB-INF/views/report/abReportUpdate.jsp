	...
	<div class="modal-dialog modal-dialog-centered ">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="f_data">
					<input type="hidden" name="afboardId" value="${adoptionFeedbackBoard.fboardId}"/>
					<input type="hidden" name="reportId" value="${adoptionFeedbackBoard.reportId}"/>
					...
					<fieldset>
						...
						<c:choose>
							<c:when test="${adoptionFeedbackBoard.reportSort == 1}">
								<div>
							...
							<c:when test="${adoptionFeedbackBoard.reportSort == 2}">
								<div>
							...
							<c:when test="${adoptionFeedbackBoard.reportSort == 3}">
								<div>
									<input type="radio" id="priority-1" name="reportSort" value="1" >
									<label for="priority-1" class="text-black">욕설<br/><small class="text-secondary">(남의 인격을 무시하는 모욕적인 말을 하는 행위)</small></label>
								</div>
							...
							<c:when test="${adoptionFeedbackBoard.reportSort == 4}">
								<div>
									<input type="radio" id="priority-1" name="reportSort" value="1" >
									<label for="priority-1" class="text-black">욕설<br/><small class="text-secondary">(남의 인격을 무시하는 모욕적인 말을 하는 행위)</small></label>
								</div>
					...
					<fieldset>
						...
						<textarea style="width: 100%; height: 10em; resize: none;" class="form-control" placeholder="신고 내용을 기입해 주세요" id="reportDetail" name="reportDetail">${adoptionFeedbackBoard.reportDetail}</textarea>
					</fieldset>
				</form>
			</div>
