...
<!-- Modal -->
<div class="modal fade text-start" id="vfcReportModal" tabindex="-1" aria-labelledby="vfcReportModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered ">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="vfcReportModalLabel"><strong>신고하기</strong></h1>
       	 		<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				
				<form id="fc_data">
					<input type="hidden" name="vfcommentId" value="${detail.vfcommentId}"/>
			...
			<div class="modal-footer">
				<button type="button" id="vfcReportInsertBtn" class="btn btn-primary button special">신고하기</button>
			</div>
		</div>
	</div>
</div>
